...
// Normalised to LF: this script matches across line breaks, and a Windows
// checkout with core.autocrlf=true would otherwise hand it \r\n and make
// every one of those matches miss. .gitattributes pins the working tree to
// LF as well; this is the belt to that pair of braces, because a false
// "no version found" here fails the release build before cargo starts.
